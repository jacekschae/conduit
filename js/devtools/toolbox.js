...
return devtools.toolbox.envelope.cljs$core$IFn$_invoke$arity$2(obj,cljs.core.cst$kw$default_DASH_envelope_DASH_header);
});

devtools.toolbox.envelope.cljs$core$IFn$_invoke$arity$2 = (function (obj,header){
return devtools.toolbox.envelope.cljs$core$IFn$_invoke$arity$3(obj,header,cljs.core.cst$kw$default_DASH_envelope_DASH_style);
});

devtools.toolbox.envelope.cljs$core$IFn$_invoke$arity$3 = (function (obj,header,style){
return devtools.toolbox.envelope.cljs$core$IFn$_invoke$arity$4(obj,header,style,cljs.core.cst$kw$span);
});

devtools.toolbox.envelope.cljs$core$IFn$_invoke$arity$4 = (function (obj,header,style,tag){
if(typeof devtools.toolbox.t_devtools$toolbox20425 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox20425 = (function (obj,header,style,tag,meta20426){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox20425.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20427,meta20426__$1){
var self__ = this;
var _20427__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox20425(self__.obj,self__.header,self__.style,self__.tag,meta20426__$1));
});

devtools.toolbox.t_devtools$toolbox20425.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20427){
var self__ = this;
var _20427__$1 = this;
return self__.meta20426;
});

devtools.toolbox.t_devtools$toolbox20425.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;

devtools.toolbox.t_devtools$toolbox20425.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox20425.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox20425.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox20425.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$obj,cljs.core.cst$sym$header,cljs.core.cst$sym$style,cljs.core.cst$sym$tag,cljs.core.cst$sym$meta20426], null);
});

devtools.toolbox.t_devtools$toolbox20425.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox20425.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox20425";

devtools.toolbox.t_devtools$toolbox20425.cljs$lang$ctorPrWriter = (function (this__8404__auto__,writer__8405__auto__,opt__8406__auto__){
return cljs.core._write(writer__8405__auto__,"devtools.toolbox/t_devtools$toolbox20425");
});

devtools.toolbox.__GT_t_devtools$toolbox20425 = (function devtools$toolbox$__GT_t_devtools$toolbox20425(obj__$1,header__$1,style__$1,tag__$1,meta20426){
return (new devtools.toolbox.t_devtools$toolbox20425(obj__$1,header__$1,style__$1,tag__$1,meta20426));
});

}

return (new devtools.toolbox.t_devtools$toolbox20425(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
