...
var temp__4655__auto__ = cljs.core.deref(devtools.hints.processed_errors);
...
var reader = (function (){var or__7779__auto__ = devtools.prefs.pref(cljs.core.cst$kw$file_DASH_reader);
...
var min_length = (function (){var or__7779__auto__ = devtools.prefs.pref(cljs.core.cst$kw$sanity_DASH_hint_DASH_min_DASH_length);
if(cljs.core.truth_(or__7779__auto__)){
return or__7779__auto__;
} else {
return (128);
...
var G__21739 = cljs.core.PersistentArrayMap.EMPTY;
var G__21740 = native_stack_trace;
var G__21741 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$ua_DASH_product,cljs.core.cst$kw$chrome], null);
var G__21742 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$asset_DASH_root,""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__21739,G__21740,G__21741,G__21742) : cljs.stacktrace.parse_stacktrace.call(null,G__21739,G__21740,G__21741,G__21742));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21744__$1,cljs.core.cst$kw$file);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21744__$1,cljs.core.cst$kw$line);
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21744__$1,cljs.core.cst$kw$column);
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e21743){var _e = e21743;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___21746 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__4655__auto___21746)){
var seen_errors_21747 = temp__4655__auto___21746;
if(cljs.core.truth_(seen_errors_21747.has(self))){
} else {
seen_errors_21747.add(self);

var temp__4657__auto___21748 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__4657__auto___21748)){
var sense_21749 = temp__4657__auto___21748;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_21749)].join('');
} else {
}
}
} else {
