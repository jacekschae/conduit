...
var G__14915 = devtools.prefs.pref(v);
v = G__14915;
continue;
} else {
return v;
...
var and__7767__auto__ = cljs.core.not(devtools.formatters.helpers.pref(cljs.core.cst$kw$disable_DASH_cljs_DASH_fn_DASH_formatting));
if(and__7767__auto__){
var and__7767__auto____$1 = !(cljs.core.var_QMARK_(value));
...
var or__7779__auto__ = (function (){try{if(!((value == null))){
...
}catch (e14918){var _e__13965__auto__ = e14918;
return false;
}})();
if(cljs.core.truth_(or__7779__auto__)){
return or__7779__auto__;
} else {
var or__7779__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e14922){var _e__13965__auto__ = e14922;
return false;
}})();
...
}catch (e14924){var _e__13965__auto__ = e14924;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__7767__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__7767__auto__)){
var and__7767__auto____$1 = cljs.core.not(devtools.formatters.helpers.is_prototype_QMARK_(f));
if(and__7767__auto____$1){
...
var and__7767__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__7767__auto__)){
...
var or__7779__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(or__7779__auto__)){
return or__7779__auto__;
} else {
...
var and__7767__auto__ = (function (){var or__7779__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_(value);
if(cljs.core.truth_(or__7779__auto__)){
return or__7779__auto__;
} else {
...
var vec__14926 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14926,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14926,(1),null);
...
var and__7767__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(and__7767__auto__)){
...
var or__7779__auto__ = typeof value === 'string';
if(or__7779__auto__){
return or__7779__auto__;
} else {
var or__7779__auto____$1 = typeof value === 'number';
...
return cljs.core.some((function (p1__14929_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(cljs.core.cst$kw$more_DASH_marker),p1__14929_SHARP_);
}),template);
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(devtools.formatters.helpers.pref(cljs.core.cst$kw$plus_DASH_symbol)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(more_count),cljs.core.str.cljs$core$IFn$_invoke$arity$1(devtools.formatters.helpers.pref(cljs.core.cst$kw$more_DASH_symbol))].join('');
});
