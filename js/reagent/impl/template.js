...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__8404__auto__,writer__8405__auto__,opt__8406__auto__){
return cljs.core._write(writer__8405__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__13792 = o;
(G__13792[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__13793__delegate = function (args){
...
while (G__13794__i < G__13794__a.length) {G__13794__a[G__13794__i] = arguments[G__13794__i + 0]; ++G__13794__i;}
  args = new cljs.core.IndexedSeq(G__13794__a,0,null);
} 
return G__13793__delegate.call(this,args);};
G__13793.cljs$lang$maxFixedArity = 0;
G__13793.cljs$lang$applyTo = (function (arglist__13795){
var args = cljs.core.seq(arglist__13795);
return G__13793__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__7767__auto__ = !((jsprops == null));
if(and__7767__auto__){
var and__7767__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__13798 = jsprops;
(G__13798["defaultValue"] = value);

(G__13798["onChange"] = ((function (G__13798,v,value,on_change){
return (function (p1__13797_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13797_SHARP_);
});})(G__13798,v,value,on_change))
);
...
var vec__13801 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13801,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13801,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13801,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___13805 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___13805 == null)){
} else {
var key_13806 = temp__4661__auto___13805;
(jsprops["key"] = key_13806);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13807 = reagent.impl.template.__GT_NativeWrapper();
(G__13807["name"] = c);
...
var G__13808 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13808) : reagent.impl.template.as_element.call(null,G__13808));
} else {
...
var len__8937__auto___13812 = arguments.length;
var i__8938__auto___13813 = (0);
while(true){
if((i__8938__auto___13813 < len__8937__auto___13812)){
args__8944__auto__.push((arguments[i__8938__auto___13813]));

var G__13814 = (i__8938__auto___13813 + (1));
i__8938__auto___13813 = G__13814;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8945__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13810){
var G__13811 = cljs.core.first(seq13810);
var seq13810__$1 = cljs.core.next(seq13810);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13811,seq13810__$1);
});
...
break;
default:
var G__13817 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13817;
continue;
...
var n__8724__auto___13819 = a.length;
var i_13820 = (0);
while(true){
if((i_13820 < n__8724__auto___13819)){
(a[i_13820] = reagent.impl.template.as_element((a[i_13820])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__8724__auto___13822 = a.length;
var i_13823 = (0);
while(true){
if((i_13823 < n__8724__auto___13822)){
var val_13824 = (a[i_13823]);
if((cljs.core.vector_QMARK_(val_13824)) && ((reagent.impl.template.key_from_vec(val_13824) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13823] = reagent.impl.template.as_element(val_13824));
...
var ctx = ({});
var vec__13826 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13826,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13826,(1),null);
...
var G__13829 = (cljs.core.count(argv) - first_child);
switch (G__13829) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13829){
