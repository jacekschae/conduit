...
var or__28485__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj41030 = {"detail":data};
return obj41030;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__28473__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__28473__auto__)){
var and__28473__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__41037 = cljs.core._EQ_;
var expr__41038 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__41037.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__41038))){
return ((function (pred__41037,expr__41038){
return (function (p1__41031_SHARP_){
return console.warn(p1__41031_SHARP_);
});
;})(pred__41037,expr__41038))
} else {
if(cljs.core.truth_(pred__41037.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__41038))){
return ((function (pred__41037,expr__41038){
return (function (p1__41032_SHARP_){
return console.debug(p1__41032_SHARP_);
});
;})(pred__41037,expr__41038))
} else {
if(cljs.core.truth_(pred__41037.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__41038))){
return ((function (pred__41037,expr__41038){
return (function (p1__41033_SHARP_){
return console.error(p1__41033_SHARP_);
});
;})(pred__41037,expr__41038))
} else {
return ((function (pred__41037,expr__41038){
return (function (p1__41034_SHARP_){
return console.log(p1__41034_SHARP_);
});
;})(pred__41037,expr__41038))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__41041){
...
var opts = map__41042__$1;
var eval_fn = cljs.core.get.call(null,map__41042__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__41044_SHARP_){
return new_def.callback(p1__41044_SHARP_);
});})(new_def))
);
...
return (function (p__41045){
var vec__41046 = p__41045;
var ky = cljs.core.nth.call(null,vec__41046,(0),null);
var v = cljs.core.nth.call(null,vec__41046,(1),null);
...
if(cljs.core.truth_((function (){var and__28473__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1512565258173
