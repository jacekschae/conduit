...
var len__4497__auto___31659 = arguments.length;
var i__4498__auto___31660 = (0);
while(true){
if((i__4498__auto___31660 < len__4497__auto___31659)){
args__4500__auto__.push((arguments[i__4498__auto___31660]));

var G__31661 = (i__4498__auto___31660 + (1));
i__4498__auto___31660 = G__31661;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4501__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq31657){
var G__31658 = cljs.core.first(seq31657);
var seq31657__$1 = cljs.core.next(seq31657);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__31658,seq31657__$1);
});
...
return (p1__31662_SHARP_ === object);
});})(history))
,history);
});
