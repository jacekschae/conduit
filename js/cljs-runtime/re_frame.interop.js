...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__34221 = cljs.core.instance_QMARK_;
var expr__34222 = reactive_val;
if(cljs.core.truth_((pred__34221.cljs$core$IFn$_invoke$arity$2 ? pred__34221.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__34222) : pred__34221.call(null,reagent.ratom.RAtom,expr__34222)))){
return "ra";
} else {
if(cljs.core.truth_((pred__34221.cljs$core$IFn$_invoke$arity$2 ? pred__34221.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__34222) : pred__34221.call(null,reagent.ratom.RCursor,expr__34222)))){
return "rc";
} else {
if(cljs.core.truth_((pred__34221.cljs$core$IFn$_invoke$arity$2 ? pred__34221.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__34222) : pred__34221.call(null,reagent.ratom.Reaction,expr__34222)))){
return "rx";
} else {
if(cljs.core.truth_((pred__34221.cljs$core$IFn$_invoke$arity$2 ? pred__34221.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__34222) : pred__34221.call(null,reagent.ratom.Track,expr__34222)))){
return "tr";
} else {
return "other";
}
