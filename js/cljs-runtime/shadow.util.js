...
var len__4497__auto___28954 = arguments.length;
var i__4498__auto___28955 = (0);
while(true){
if((i__4498__auto___28955 < len__4497__auto___28954)){
args__4500__auto__.push((arguments[i__4498__auto___28955]));

var G__28956 = (i__4498__auto___28955 + (1));
i__4498__auto___28955 = G__28956;
continue;
} else {
}
break;
...
return shadow.util.go_BANG_.cljs$core$IFn$_invoke$arity$variadic(argseq__4501__auto__);
});
...
shadow.util.go_BANG_.cljs$lang$applyTo = (function (seq28949){
return shadow.util.go_BANG_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq28949));
});
...
var len__4497__auto___28978 = arguments.length;
var i__4498__auto___28979 = (0);
while(true){
if((i__4498__auto___28979 < len__4497__auto___28978)){
args_arr__4512__auto__.push((arguments[i__4498__auto___28979]));

var G__28980 = (i__4498__auto___28979 + (1));
i__4498__auto___28979 = G__28980;
continue;
} else {
}
break;
...
var argseq__4513__auto__ = (new cljs.core.IndexedSeq(args_arr__4512__auto__.slice((6)),(0),null));
return shadow.util.log.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),(arguments[(3)]),(arguments[(4)]),(arguments[(5)]),argseq__4513__auto__);
...
shadow.util.log.cljs$lang$applyTo = (function (seq28965){
...
var G__28968 = cljs.core.first(seq28965__$2);
var seq28965__$3 = cljs.core.next(seq28965__$2);
var G__28969 = cljs.core.first(seq28965__$3);
var seq28965__$4 = cljs.core.next(seq28965__$3);
var G__28970 = cljs.core.first(seq28965__$4);
var seq28965__$5 = cljs.core.next(seq28965__$4);
var G__28971 = cljs.core.first(seq28965__$5);
var seq28965__$6 = cljs.core.next(seq28965__$5);
return shadow.util.log.cljs$core$IFn$_invoke$arity$variadic(G__28966,G__28967,G__28968,G__28969,G__28970,G__28971,seq28965__$6);
});

shadow.util.log.cljs$lang$maxFixedArity = (6);

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__28981){
var vec__28982 = p__28981;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28982,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28982,(1),null);
