...
var reader = (function (){var or__3922__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__3922__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
return (128);
...
var G__29703 = cljs.core.PersistentArrayMap.EMPTY;
var G__29704 = native_stack_trace;
var G__29705 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__29706 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__29703,G__29704,G__29705,G__29706) : cljs.stacktrace.parse_stacktrace.call(null,G__29703,G__29704,G__29705,G__29706));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29717__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29717__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29717__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e29716){var _e = e29716;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___29721 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5455__auto___29721)){
var seen_errors_29722 = temp__5455__auto___29721;
if(cljs.core.truth_(seen_errors_29722.has(self))){
} else {
seen_errors_29722.add(self);

var temp__5457__auto___29723 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5457__auto___29723)){
var sense_29724 = temp__5457__auto___29723;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_29724)].join('');
} else {
}
}
} else {
