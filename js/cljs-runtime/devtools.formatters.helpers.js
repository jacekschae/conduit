...
var G__31606 = devtools.prefs.pref(v);
v = G__31606;
continue;
} else {
return v;
...
var and__3911__auto__ = cljs.core.not(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__3911__auto__){
var and__3911__auto____$1 = !(cljs.core.var_QMARK_(value));
...
}catch (e31610){var _e__29542__auto__ = e31610;
return false;
}})();
...
}catch (e31614){var _e__29542__auto__ = e31614;
return false;
}})();
...
}catch (e31616){var _e__29542__auto__ = e31616;
return false;
}}
}
});
...
var and__3911__auto____$1 = cljs.core.not(devtools.formatters.helpers.is_prototype_QMARK_(f));
if(and__3911__auto____$1){
...
var or__3922__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
var and__3911__auto__ = (function (){var or__3922__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_(value);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
var vec__31624 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31624,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31624,(1),null);
...
var and__3911__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(and__3911__auto__)){
...
return cljs.core.some((function (p1__31637_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__31637_SHARP_);
}),template);
});
