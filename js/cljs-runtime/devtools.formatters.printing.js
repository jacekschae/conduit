...
var len__4497__auto___31666 = arguments.length;
var i__4498__auto___31667 = (0);
while(true){
if((i__4498__auto___31667 < len__4497__auto___31666)){
args__4500__auto__.push((arguments[i__4498__auto___31667]));

var G__31668 = (i__4498__auto___31667 + (1));
i__4498__auto___31667 = G__31668;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4501__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq31663){
var G__31664 = cljs.core.first(seq31663);
var seq31663__$1 = cljs.core.next(seq31663);
var G__31665 = cljs.core.first(seq31663__$1);
var seq31663__$2 = cljs.core.next(seq31663__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__31664,G__31665,seq31663__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__31714_SHARP_){
return !((cljs.core.meta(p1__31714_SHARP_) == null));
})))){
...
var map__31732 = opts;
var map__31732__$1 = ((((!((map__31732 == null)))?(((((map__31732.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__31732.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__31732):map__31732);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31732__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e31742){var _e__29542__auto__ = e31742;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e31745){var _e__29542__auto__ = e31745;
return false;
}}
})())){
...
var _STAR_current_state_STAR_31763 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state();

try{var map__31764 = opts;
var map__31764__$1 = ((((!((map__31764 == null)))?(((((map__31764.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__31764.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__31764):map__31764);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31764__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_31763;
}});
...
;
var temp__5455__auto___31775 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5455__auto___31775)){
var managed_print_level_31776 = temp__5455__auto___31775;
var _STAR_print_level_STAR_31773_31777 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_31776;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR_31773_31777,managed_print_level_31776,temp__5455__auto___31775,writer,opts,job_fn){
return (function (p1__31769_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__31769_SHARP_,null);
});})(_STAR_print_level_STAR_31773_31777,managed_print_level_31776,temp__5455__auto___31775,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_31773_31777;
}} else {
job_fn();
}
