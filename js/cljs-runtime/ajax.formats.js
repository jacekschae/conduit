...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__35658){
...
var request = map__35659__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35659__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__35663 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__35663.cljs$core$IFn$_invoke$arity$1 ? fexpr__35663.cljs$core$IFn$_invoke$arity$1(response) : fexpr__35663.call(null,response));
});

ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__35664 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__35664.cljs$core$IFn$_invoke$arity$1 ? fexpr__35664.cljs$core$IFn$_invoke$arity$1(response) : fexpr__35664.call(null,response));
});
});

ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2;

ajax.formats.accept_header = (function ajax$formats$accept_header(p__35666){
...
var request = map__35667__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35667__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
