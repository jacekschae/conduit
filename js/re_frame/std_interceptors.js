...
var vec__16998_17001 = clojure.data.diff(orig_db,new_db);
var only_before_17002 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16998_17001,(0),null);
var only_after_17003 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16998_17001,(1),null);
var db_changed_QMARK__17004 = (!((only_before_17002 == null))) || (!((only_after_17003 == null)));
if(db_changed_QMARK__17004){
...
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["only before:",only_before_17002], 0));

re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["only after :",only_after_17003], 0));
...
var map__17005 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17005__$1,cljs.core.cst$kw$db);
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17005__$1,cljs.core.cst$kw$event);
...
var map__17007 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__17007__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17007__$1,cljs.core.cst$kw$event);
...
var len__9346__auto___17010 = arguments.length;
var i__9347__auto___17011 = (0);
while(true){
if((i__9347__auto___17011 < len__9346__auto___17010)){
args__9353__auto__.push((arguments[i__9347__auto___17011]));

var G__17012 = (i__9347__auto___17011 + (1));
i__9347__auto___17011 = G__17012;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__9354__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq17009){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq17009));
});
...
var event = re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$2(context,cljs.core.cst$kw$event);
var db = (function (){var or__8186__auto__ = re_frame.interceptor.get_effect.cljs$core$IFn$_invoke$arity$2(context,cljs.core.cst$kw$db);
...
var args__9353__auto__ = [];
var len__9346__auto___17018 = arguments.length;
var i__9347__auto___17019 = (0);
while(true){
if((i__9347__auto___17019 < len__9346__auto___17018)){
args__9353__auto__.push((arguments[i__9347__auto___17019]));

var G__17020 = (i__9347__auto___17019 + (1));
i__9347__auto___17019 = G__17020;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__9354__auto__);
});
...
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(new_db,p1__17013_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (new_db,old_db,new_ins){
return (function (p1__17014_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(old_db,p1__17014_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__8174__auto__ = cljs.core.contains_QMARK_(re_frame.interceptor.get_effect.cljs$core$IFn$_invoke$arity$1(context),cljs.core.cst$kw$db);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq17015){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__17016,G__17017,seq17015__$2);
});
