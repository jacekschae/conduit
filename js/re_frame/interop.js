...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__13939 = cljs.core.instance_QMARK_;
var expr__13940 = reactive_val;
if(cljs.core.truth_((pred__13939.cljs$core$IFn$_invoke$arity$2 ? pred__13939.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__13940) : pred__13939.call(null,reagent.ratom.RAtom,expr__13940)))){
return "ra";
} else {
if(cljs.core.truth_((pred__13939.cljs$core$IFn$_invoke$arity$2 ? pred__13939.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__13940) : pred__13939.call(null,reagent.ratom.RCursor,expr__13940)))){
return "rc";
} else {
if(cljs.core.truth_((pred__13939.cljs$core$IFn$_invoke$arity$2 ? pred__13939.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__13940) : pred__13939.call(null,reagent.ratom.Reaction,expr__13940)))){
return "rx";
} else {
if(cljs.core.truth_((pred__13939.cljs$core$IFn$_invoke$arity$2 ? pred__13939.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__13940) : pred__13939.call(null,reagent.ratom.Track,expr__13940)))){
return "tr";
} else {
return "other";
}
